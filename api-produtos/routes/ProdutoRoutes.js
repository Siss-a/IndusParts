...
router.post('/registrar', authMiddleware, adminMiddleware, uploadImagem.single('imagem'), ProdutoController.criarProduto);
router.post('/upload', authMiddleware, adminMiddleware, uploadImagem.single('imagem'), ProdutoController.uploadImagem);
router.put('/:id', authMiddleware, adminMiddleware, uploadImagem.single('imagem'), ProdutoController.atualizarProduto);
router.delete('/:id', authMiddleware, adminMiddleware, ProdutoController.excluirProduto);

// READ
router.get('/buscar', ProdutoController.listarProdutos);
