...
try {
    fetch(`/api/produtos/${id}`)
        ...
        .then((produto) => {
            ...
            let categoriaProd;
            switch (produto.categoria) {case "Usinagem": categoriaProd = "fresas-de-usinagem"; break;
                case "Ferramentas de Furação":
                    categoriaProd = "ferramentas-de-furacao";
                    break;
                case "Fixação":
                    categoriaProd = "fixacao";
                    break;
                case "Cortes":
                    categoriaProd = "cortes";
                    break;
                case "Parafusadeiras":
                    categoriaProd = "parafusadeiras";
                    break;
                case "Acessórios para Fixação":
                    categoriaProd = "acessoriosparafixacao";
                    break;
                default:
                    categoriaProd = "todos";
            }
            ...
            especificacoes.forEach(
                (espe) => (espe.textContent = produto.especificacoes)
            );
